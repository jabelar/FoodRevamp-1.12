...
{
    public static final String MODID = "foodrevamp";
    public static final String MODNAME = "Food Revamp";
    public static final String MODVERSION = "1.0.0";
    public static final String MODDESCRIPTION = "Streamlines food.";
    public static final String MODAUTHOR = "JnaeJnae";
    ...
    @SidedProxy(clientSide="com.blogspot.jabelarminecraft.foodrevamp.proxy.ClientProxy", serverSide="com.blogspot.jabelarminecraft.foodrevamp.proxy.CommonProxy")
